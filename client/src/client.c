...
int main(int argc, char *argv[]) {
    ...
    gtk_window_set_title(GTK_WINDOW(t_application.window), "GeekChat");                         // Setting window title
    ...
    gtk_window_set_icon_name(GTK_WINDOW(t_application.window), "GeekChat");
    ...
    t_application.settings = gtk_fixed_new();
    gtk_fixed_put(GTK_FIXED(main_area), t_application.settings, 0, 0);
    gtk_widget_set_size_request(GTK_WIDGET(t_application.settings), WINDOW_WIDTH, WINDOW_HEIGHT);
